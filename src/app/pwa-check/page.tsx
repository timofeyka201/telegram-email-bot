  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      out.push({
        ...
        note: standalone
          ? undefined
          : "Если вы открыли эту страницу с ярлыка на домашнем экране и здесь написано «вкладкой» — браузер создал закладку, а не приложение. Нужен пункт меню «Установить приложение», а не «Добавить на главный экран».",
      });
