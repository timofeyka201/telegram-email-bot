...
const items = [
  ...
  { href: "/wishlist", label: "Вишлист", Icon: IconBookmark },
        ...
        {items.map(({ href, label, Icon }) => {
          ...
          return (
            <Link
              ...
              className={`relative flex flex-1 flex-col items-center gap-1 pb-2 pt-2.5 text-[10px] font-bold transition-colors ${
