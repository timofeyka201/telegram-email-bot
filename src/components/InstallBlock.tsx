            ...
            {howTo && (
              <>
                <Steps>
                  ...
                  <li>
                    Выберите именно <b>«Установить приложение»</b>.
                  </li>
                  <li>Подтвердите — ярлык появится рядом с остальными приложениями.</li>
                </Steps>
                {way === "yandex-android" && (
                  <p className="mt-2.5 text-[12px] leading-snug text-[var(--color-muted)]">
                    «Добавить на главный экран» — это другое: браузер делает закладку, и она
                    открывается обратно вкладкой, с адресной строкой. Если пункта «Установить
                    приложение» в меню нет, Яндекс.Браузер этой версии приложения ставить не умеет —
                    откройте сайт в Samsung Internet или Chrome, приложение будет то же самое.
                  </p>
                )}
              </>
            )}
